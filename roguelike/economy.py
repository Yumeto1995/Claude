...
BASE_VALUE = {
    ...
    "卵": 24, "ミルク": 30,
    # 魚・海産
    "魚": 22, "大魚": 48, "フグ": 30, "貝": 22,
    # その他食材
    "肉": 26, "イモ": 20, "果実": 20, "チーズ": 36, "蜂蜜": 42, "携帯食料": 28,
    # 素材
    "スライムのかけら": 12, "ゴブリンの爪": 14, "毒キノコ": 8, "エサ": 6, "飼料": 8,
    "ニワトリ": 40, "ウシ": 80,
}
CATEGORY_VALUE = {
    item_category.ItemCategory.CONSUMABLE: 30,   # 料理など
    item_category.ItemCategory.MATERIAL: 12,
